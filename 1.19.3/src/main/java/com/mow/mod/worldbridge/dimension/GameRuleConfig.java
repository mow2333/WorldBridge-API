...
public class GameRuleConfig {
    ...
    public Integer getRandomTickSpeed() { return randomTickSpeed; }
    public void setRandomTickSpeed(Integer v) { randomTickSpeed = v; }
    ...
    public CompoundTag toNbt() {
        ...
        if (randomTickSpeed != null) tag.putInt("RandomTickSpeed", randomTickSpeed);
        return tag;
    }
    ...
    public static GameRuleConfig fromNbt(CompoundTag tag) {
        ...
        if (tag.contains("RandomTickSpeed")) config.randomTickSpeed = tag.getInt("RandomTickSpeed");
        return config;
    }
}
